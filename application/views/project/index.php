	...
	>
		...
		<div>
			<a
				...
				href="<?php print URL::$base; ?>/project/add"
			>Add New Project</a>
		</div>
		<br>
				...
				>
					...
					>
						...
						<a
							...
							href="<?php print URL::$base; ?>/project/<?php print $project->id; ?>"
						>View Project</a>
						<a
							class="btn btn-inverse btn-large"
							href="<?php print URL::$base; ?>/project/<?php print $project->id; ?>/edit"
						>Edit Project</a>
						<a
							class="btn btn-danger btn-large"
							href="<?php print URL::$base; ?>/project/<?php print $project->id; ?>/remove"
						>Delete Project</a>
					</div>
				</div>
			</div>
		...
		>There no projects to show.</span>
		<?php endif; ?>
	</div>
	<div
		class="span3"
