...
<!DOCTYPE html>
<!--[if lt IE 7]>
<html class="lt-ie7 lt-ie8 lt-ie9 no-js">
<![endif]-->
<!--[if IE 7]>
<html class="lt-ie8 lt-ie9 no-js">
<![endif]-->
<!--[if IE 8]>
...
<!--<![endif]-->
	<head>
		...
		<title><?php print Section::yield('head_title'); ?> &#171; <?php print Section::yield('application_name'); ?></title>
			...
			<div class="navbar-inner">
				<div class="container">
					<a class="btn btn-navbar" data-target=".nav-collapse" data-toggle="collapse" href="#">
						<span class="icon-bar icon-large"></span>
						<span class="icon-bar icon-large"></span>
						<span class="icon-bar icon-large"></span>
					</a>
